...
export function MobileNav() {
  const currentPath = "/"; // In real app, use usePathname()
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                ...
                {item.badge && (
                  <span className="absolute -top-1 -right-2 w-4 h-4 bg-primary-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center">
                    {item.badge}
                  </span>
                )}
              </div>
              ...
              {/* Label */}
              <span className={`text-[10px] mt-1 font-medium ${isActive ? "text-primary-500" : ""}`}>
                {item.label}
              </span>
