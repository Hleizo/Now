        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center gap-8">
          ...
          <div className="flex-1 max-w-2xl">
            <div className="relative">
              ...
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-action-500 hover:bg-action-600 text-white px-6 py-2 rounded-xl font-semibold transition-colors">
                Search
              </button>
            </div>
          </div>
      ...
      <div className="md:hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-white">
          ...
          <a href="/" className="flex items-center gap-2">
            <div className="w-10 h-10 bg-navy-500 rounded-xl flex items-center justify-center shadow-sm">
              <span className="text-white font-extrabold text-xl">N</span>
            </div>
            <span className="text-xl font-extrabold text-navy-500">Now</span>
          </a>

          {/* Location */}
          <button className="flex items-center gap-1 text-sm">
            <MapPinIcon className="w-4 h-4 text-action-500" />
            <span className="text-text-secondary max-w-[80px] truncate">Amman</span>
          </button>

          {/* Icons */}
          <div className="flex items-center gap-1">
            <a href="/wishlist" className="relative p-2 rounded-xl active:bg-surface touch-target">
              <HeartIcon className="w-6 h-6 text-navy-500" />
              <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-action-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center">
                5
              </span>
            </a>
            <a href="/cart" className="relative p-2 rounded-xl active:bg-surface touch-target">
              <CartIcon className="w-6 h-6 text-navy-500" />
              <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-action-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center">
                3
              </span>
        ...
        <div className="px-4 pb-3 bg-white">
          ...
          >
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-surface rounded-xl border-2 border-transparent focus:border-action-500 focus:bg-white focus:outline-none transition-all text-base text-text-primary placeholder:text-text-muted"
              aria-label="Search products"
